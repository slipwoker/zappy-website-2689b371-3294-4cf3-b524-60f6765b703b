document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (isFormValid) {
        ...
        setTimeout(function () {
          successMessage.textContent = contactForm.dataset.successMessage || 'Thank you! Your message has been sent.';
          successMessage.style.display = 'block';
          contactForm.reset();

          getFormFields(contactForm).forEach(function (field) {
            const wrapper = field.closest('.form-group, .field-wrapper, [data-field]') || field.parentElement;
    ...
    contactForm.addEventListener('input', function (e) {
      const field = e.target;
      if (field.matches('input, textarea, select') && field.getAttribute('aria-invalid') === 'true') {
        validateField(field);
      }
    });
  }
  ...
  const ANIMATE_SELECTOR = '.animate-on-scroll, [data-animate], .fade-in-element';
  ...
  animationStyles.textContent = [
    ...
    '}',
    '[data-animate-direction="left"].is-visible {',
    '  transform: translateX(0);',
    '}',
    '[data-animate-direction="right"] {',
    '  transform: translateX(30px);',
    '}',
    '[data-animate-direction="right"].is-visible {',
    '  transform: translateX(0);',
    '}',
  ...
  (function applyRTLSupport() {
    ...
    if (isRTL) {
      ...
      rtlStyles.textContent = [
        '[dir="rtl"] [data-animate-direction="left"] {',
        '  transform: translateX(30px);',
        '}',
        '[dir="rtl"] [data-animate-direction="right"] {',
        '  transform: translateX(-30px);',
        '}',
        '[dir="rtl"] [data-animate-direction="left"].is-visible,',
        '[dir="rtl"] [data-animate-direction="right"].is-visible {',
        '  transform: translateX(0);',
        '}'
      ].join('\n');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2689b371-3294-4cf3-b524-60f6765b703b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2689b371-3294-4cf3-b524-60f6765b703b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2689b371-3294-4cf3-b524-60f6765b703b';
